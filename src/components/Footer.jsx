...
export default function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-border">
      ...
      {/* Quote strip */}
      <div className="border-b border-border py-5 px-4 sm:px-8 md:px-13
                      group cursor-default transition-colors duration-300
                      hover:bg-gray-50">
        <div className="sec-inner text-center">
          <p className="text-[12px] sm:text-[13px] italic
                        text-gray-300 group-hover:text-gray-900
                        transition-colors duration-300">
            "Whether you think you can, or you think you can't — you're right."
            <span className="not-italic font-semibold ml-1.5
                             text-gray-300 group-hover:text-gray-900
                             transition-colors duration-300">
              — Henry Ford
            </span>
        ...
        <div className="sec-inner flex flex-col sm:flex-row items-center
          ...
          <div className="flex gap-5 order-1 sm:order-2">
            <a href={DATA.github} target="_blank" rel="noreferrer"
              className="text-[12px] text-pale no-underline
