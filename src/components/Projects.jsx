...
function ProjectCard({ proj }) {
  ...
  return (
    <div className="border border-border rounded-[18px] overflow-hidden bg-white
      ...
      {/* Info */}
      <div className="p-3.5 sm:p-4 border-t border-gray-50">
        <div className="text-[13px] sm:text-[14px] font-semibold text-ink mb-1 truncate">
          {proj.title}
        </div>

        {/* Description — line-clamp-3 mobile, line-clamp-2 desktop, none on hover */}
        <p className="text-[11px] sm:text-[12px] text-muted leading-[1.55] mb-2 sm:mb-2.5
                      line-clamp-3 sm:line-clamp-2 group-hover:line-clamp-none
        ...
        <div className="flex gap-1 sm:gap-1.5 flex-wrap">
          {proj.tags.slice(0, 4).map(t => (
            <span key={t}
              className="text-[9px] sm:text-[10px] px-2 sm:px-2.5 py-0.5
